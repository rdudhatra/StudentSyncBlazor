...
namespace StudentSyncBlazor.Core.Wrapper
{
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public static ErrorResult<T> ReturnError(string message, int errorCode)
        {
            return new()
            {
                Succeeded = false,
        ...
        public static ErrorResult<T> ReturnError(List<string> messages, int errorCode)
        {
            return new() { Succeeded = false, Messages = messages, ErrorCode = errorCode };
        }
        ...
        public static Task<ErrorResult<T>> ReturnErrorAsync(string message, int errorCode)
        {
            return Task.FromResult(ReturnError(message, errorCode));
        }
        ...
        public static Task<ErrorResult<T>> ReturnErrorAsync(List<string> messages, int errorCode)
        {
            return Task.FromResult(ReturnError(messages, errorCode));
        }

        public new static Result<T> Success(List<Data.Models.Course> courses)
        {
